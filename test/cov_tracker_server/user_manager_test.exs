defmodule CovTrackerServer.UserManagerTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{password: "some password", type: 42, username: "some username"}
    @update_attrs %{
      password: "some updated password",
      type: 43,
      username: "some updated username"
    }
    @invalid_attrs %{password: nil, type: nil, username: nil}
